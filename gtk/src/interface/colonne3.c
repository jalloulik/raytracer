...
/*   Updated: 2018/06/14 11:55:50 by tfavart          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ft_colonne3(t_interface *inter)
{
	...
	ft_1d_button(&(inter->refract.pourcent), inter->cont.colonne3, "refract %");
	ft_switch(&inter->reflect.on_off, inter->cont.colonne3, "reflect");
	ft_1d_button(&(inter->reflect.pourcent), inter->cont.colonne3, "reflect %");
}
