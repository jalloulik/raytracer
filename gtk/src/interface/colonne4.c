...
/*   Updated: 2018/06/11 17:01:44 by tfavart          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_colonne4(t_interface *inter)
{
	...
	ft_switch(&inter->sinus.on_off, inter->cont.colonne4, "sinus");
	ft_2d_button(&(inter->sinus.sin_x), inter->cont.colonne4, "sin.x");
	ft_2d_button(&(inter->sinus.sin_y), inter->cont.colonne4, "sin.y");
	ft_2d_button(&(inter->sinus.sin_z), inter->cont.colonne4, "sin.z");
	ft_switch(&inter->checker.on_off, inter->cont.colonne4, "checker");
	ft_2d_button(&(inter->checker.move), inter->cont.colonne4, "move");
	ft_2d_button(&(inter->checker.scale), inter->cont.colonne4, "scale");
